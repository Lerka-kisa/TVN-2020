...
#define LICH_DEFAULT	0x00000000			//значение по умолчанию для lichba
...
#define LICH_MAXSIZE   32767				//максимальное значение для типа lichba
#define LICH_MINSIZE  -32768				//минимальное значение для типа lichba
...
namespace IT
{
	enum IDDATATYPE { LICH = 1, STR = 2, PROC = 3, UNDEF };//типы данных идентификаторов: числовой, строковый, без типа(для процедур), неопределенный
